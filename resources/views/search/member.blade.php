...
@section('content')
<main id="main" class=" no-left-margin">
      ...
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="d-grid gap-2 mt-3">
            <a class="btn btn-primary py-3" href="{{route('member.login') }}">User Login</a>
            <a class="btn btn-dark py-3" href="{{route('admin.member.info', ['qr_id' => $member->qr_id])}}">Admin Login</a>
          </div>
        </div>
